...
const TEXTS = ["Aset", "Beyond kWh", "Lahan", "Pendapatan"];
            ...
            >
              ...
              >
                ...
                <p className="text-[17px] 2xl:text-[20px] mt-[20px]">
                  ...
                  <b>Pendayagunaan Aset Properti</b> ada disini biar nyarinya
                  gampang ya gaess
                </p>
              ...
              >
                <div className="inline-flex mt-[30px] lg:mt-[50px] mb-[80px] space-x-[15px] lg:space-x-[24px]">
                  <Link
                    href={
                      "https://docs.google.com/spreadsheets/d/1YBHutvtBX1Krq0cDQ4n3rmT6VUZ20XvKeLVyxviZrv0/edit#gid=0"
                    }
